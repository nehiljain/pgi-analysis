...
chr_no = str(sys.argv[1])

print chr_no

snplist_filepath = r'/share/volatile_scratch/nehil/pgi_wc/mouse/dna_seq/kacper_filtered_snp_list_csv/snp_list_chr'+ chr_no +'.csv'
print snplist_filepath
...
sync_list = os.listdir(sync_dir_path)
pattern = re.compile(chr_no + ":")

sync_filename = [x for x in sync_list if re.search(pattern, x)]
print sync_filename
sync_filepath = sync_dir_path + sync_filename[0]
